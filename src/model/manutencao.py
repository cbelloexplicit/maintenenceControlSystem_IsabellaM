...
class Manutencao:
    def __init__(self, id_manutencao:int, obs_servico:str, visita:VisitaTecnica, catalogo_acao:CatalogoAcoes, defeito:Defeito):
    ...
    def get_catalogo_acao(self) -> CatalogoAcoes: return self.__catalogo_acao
    ...
    def set_catalogo_acao(self, catalogo_acao:CatalogoAcoes): self.__catalogo_acao = catalogo_acao
