class Empresa:
    def __init__(self, id_empresa:str, nome_fantasia:str, endereco:str):
    ...
    # Setters
    def set_id_empresa(self, id_empresa:str):
        self.__id_empresa = id_empresa
    ...
    def to_string(self) -> str:
        return f"CNPJ (ID): {self.get_id_empresa()} | Nome Fantasia: {self.get_nome_fantasia()}"